...
public class ProfilePage {
    ...
    public static void ClickonNewBillingAddress(WebDriver driver) throws IOException, WriteException {

        String st=RequestNewAdd(driver).get(0).getText();
    ...
    public static void AssertVerifyForLable(WebDriver driver) throws IOException, WriteException {
